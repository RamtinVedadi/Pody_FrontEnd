<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <nav class="fontMain" style="z-index: 5">
        <v-app-bar class="hidden-xs-only hidden-sm-only" app color="primary" light flat>
            <router-link to="/">
                <v-img :src="require('../assets/12.png')" width="72" height="72" max-width="72"
                       max-height="72">
                </v-img>
            </router-link>
            ...
            <div class="align-center d-flex">
                <router-link to="/">
                    <v-img :src="require('../assets/PODYYY1.png')" max-width="80px" max-height="56px">
                    </v-img>
                </router-link>
                                ...
                                <v-list class="pt-5">
                                    <v-list-item-group>
                                        <v-list-item disabled>
                                            <v-list-item-title>حالت شب</v-list-item-title>
                                            <v-list-item-action>
                                        ...
                                        <v-list-item-group>
                                            <v-list-item v-for="item in userNavigation" :key="item.id"
                                                ...
                                                <v-list-item-icon class="pr-4">
                                                    <v-icon :disabled="item.disable" v-text="item.icon"
                                                            style="color: #606060">
                                                    </v-icon>
                                                </v-list-item-icon>
                                                <v-list-item-content>
                                    ...
                                    <v-list>
                                        ...
                                        <v-list-item-group>
                                            <v-list-item @click="sheet = !sheet">
                                                <v-list-item-icon class="pr-4">
                                                    <v-icon style="color: #606060">mdi-cog</v-icon>
                                                </v-list-item-icon>
                                                <v-list-item-content>
                                                    <v-list-item-title class="listTitle">تنظیمات
                                                    </v-list-item-title>
                                                </v-list-item-content>
                                            </v-list-item>
                                                ...
                                                <v-sheet class="text-center" height="200px">
                                                    <v-row>
                                                        <v-col cols="3" class="float-right">
                                                            <v-list>
                                                                <v-list-item-group>
                                                                    <div v-if="pageIsChannel === false">
                                                                        <v-list-item
                                                                                @click="buttonRedirect( '/update/channel')">
                                                                            <v-list-item-icon class="pr-4">
                                                                            ...
                                                                            <v-list-item-content>
                                                                                <v-list-item-title class="listTitle">
                                                                                    تبدیل اکانت به کانال
                                                                                </v-list-item-title>
                                                                            </v-list-item-content>
                                                                        </v-list-item>
                                                                    </div>

                                                                    <v-list-item @click="buttonRedirect('/')">
                                                                        <v-list-item-icon class="pr-4">
                                                                            <v-icon style="color: #606060">
                                                                                mdi-rss-box
                                                                            </v-icon>
                                                        ...
                                                        <v-col cols="1" class="float-left">
                                                            <v-btn text color="red" large style="font-size: 17px;"
                                                                   @click="sheet = !sheet">
                                                                بستن
                                                            </v-btn>
                                                        </v-col>
        ...
        <v-app-bar app color="primary" light flat
            ...
            <router-link to="/">
                <v-img :src="require('../assets/12.png')" max-width="72px" max-height="72px">
                </v-img>
            </router-link>
    ...
    export default {
        ...
        methods: {
            ...
            buttonRedirect(url) {
                ...
                if (url === '/update/channel') {
                    this.$router.push('/update/channel');
                }
                if (url === '/Login') {
        ...
        beforeMount() {
            this.checkLogin();
            if (this.$store.state.user[0].isChannel === false) {
                this.userNavigation[0].disable = true;
                this.userNavigation[3].disable = true;
            }
            if (this.$store.state.user[0].isChannel === true) {
                this.pageIsChannel = true;
            }
        },
        updated() {
