...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      checkUsername(UsernameSignUpUser) {
        axios.post('http://localhost:8084/api/user/check/username', {
      ...
      checkEmail(EmailSignUpUser) {
        axios.post('http://localhost:8084/api/user/check/email', {
