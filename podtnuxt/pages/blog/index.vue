...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //   axios.post("http://localhost:8084/api/blog/list/" + this.page + "/" + this.size, {id: null}).then(response => {
            //     this.blog = response.data;
            //   });
            // } else {
            //   axios.post("http://localhost:8084/api/blog/list/" + this.page + "/" + this.size, {id: this.$store.state.user[0].userId}).then(response => {
            //     this.blog = response.data;
            //   });
            // }
            // let title = "پادی بلاگ | کمدی، تکنولوژی، داستانی، موسیقی و کسب، کار و ... ";
