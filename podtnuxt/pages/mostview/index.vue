...
<script>
    ...
    export default {
        ...
        async asyncData(context) {
            axios.get('http://localhost:8084/api/podcast/list/view/' + context.till + '/' + context.to).then((response) => {
                return {
        ...
        methods: {
            ...
            async loadMorePodcasts($state) {
                this.till += 1;
                await this.$axios.get('http://localhost:8084/api/podcast/list/view/' + this.till + '/' + this.to).then((response) => {
