  ...
  export default {
    ...
    methods: {
      ...
      loadMorePodcasts($state) {
        this.till += 1;
        axios.post('http://localhost:8084/api/podcast/list/followings/' + this.till + '/' + this.to, {id: 'fde74f03-3ecb-4151-9ca9-416b23d340c2'}).then((response) => {
    ...
    created() {
      // axios.post('http://localhost:8084/api/podcast/list/followings/' + this.till + '/' + this.to, {id: this.$store.state.user[0].userId}).then((response) => {
