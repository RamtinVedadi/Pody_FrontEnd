<template>
    <div class="fontMain">
                        ...
                        <div class="pr-10" style="width: 90%;" v-for="(items) in users" :key="items.id">
                            <v-row style="margin: 10px 0 30px 10px">
                                <div class="channel-image">
                                    <div style="display: inline-block;height: 100%;width: 100%;overflow: hidden;border-radius: 4px;background-color: inherit">
        ...
        <v-card class="pageMdAndDown hidden-sm-only hidden-xs-only" flat
            ...
            <!--Tabs-->
            <v-tabs color="basil" grow class="pr-4 ">
                <v-tab>
                    <div class="tabsFontSize">پادکست ها</div>
                </v-tab>
                <v-tab>
        ...
        <v-card class="pageXsOnlyAndMsOnly" flat v-show="$vuetify.breakpoint.xsOnly || $vuetify.breakpoint.smOnly">
            ...
            <!--Tabs-->
            <v-tabs color="basil" mobile-break-point>
                <v-tab>
                    <div class="tabsFontSize">پادکست ها</div>
                </v-tab>
                <v-tab>
...
<script>
    ...
    export default {
        ...
        layout: "pody",
        scrollToTop: true,
        components: {Loader, MobileCardPlayer, CardPlayer},
        async asyncData(context) {
            return axios.post('http://localhost:8084/api/search', {
                value: context.route.params.id
            }).then(response => {
