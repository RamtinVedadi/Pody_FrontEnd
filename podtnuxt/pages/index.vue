        ...
        <div class="pageMdAndUp hidden-md-only hidden-md-and-down hidden-sm-and-down"
            ...
            <div v-else>
                ...
                <div v-if="suggestions.length !== 0">
                    ...
                    <div style="position: relative;width: 100%">
                        <v-row class="flexi ma-4" id="suggestionId" v-dragscroll>
                            <v-layout style="z-index: 0;width: 100%">
                ...
                <div class="pb-4">
                    <div class="views">
                        <h2 class="mx-7">موسیقی های آرامش بخش</h2>
                    </div>

                    <v-row class="pt-5 pr-10">
                        <v-card height="250" max-width="95%" shaped elevation="10">
                            <v-img class="cursor" src="http://pody.ir/defaultImages/muharram_cover.jpg"
                                   height="250" max-width="100%" min-width="100%"
                                   aria-label="موسیقی های آرامش بخش" title="موسیقی های آرامش بخش"
                                   @click="publisherPageNavigation('86055d0c-6dae-4086-ac10-08d381723f60')">
                            </v-img>
                        </v-card>
                    </v-row>
                </div>

                <div class="pb-4" v-if="playlist.length !== 0">
                    <v-row justify="center" class="pt-2 pr-8 pl-12">
                        <v-col v-for="(item , index) in playlist" :key="index" cols="6">
                            <v-row justify="start" class="pb-2">
                                <div class="views">
                                    <h2 class="mx-7" style="white-space: nowrap;">{{item.title}}</h2>
                                </div>
                            </v-row>
                            <v-card height="150" max-width="100%" min-width="100%" width="100%" shaped>
                                <v-img class="cursor" :src="item.imageAddress"
                                       height="150" max-width="100%" min-width="100%" @click="toPlaylist(item.id)">
                                </v-img>
                            </v-card>
                        </v-col>
                    </v-row>
        ...
        <div class="pageXsOnlyAndMsOnly" v-show="$vuetify.breakpoint.xsOnly || $vuetify.breakpoint.smOnly">
            ...
            <div v-else>
                ...
                <div style="background-color: white">
                    <div class="views">
                        <h2 class="pr-3">موسیقی های آرامش بخش</h2>
                    </div>

                    <v-row class="pt-2 pr-5">
                        <v-card height="150" max-width="95%" shaped>
                            <v-img class="cursor" src="http://pody.ir/defaultImages/muharram_cover.jpg"
                                   height="150" max-width="100%" min-width="100%"
                                   aria-label="موسیقی های آرامش بخش" title="موسیقی های آرامش بخش"
                                   @click="publisherPageNavigation('86055d0c-6dae-4086-ac10-08d381723f60')">
                            </v-img>
                        </v-card>
                ...
                <div class="pb-2" v-if="playlist.length !== 0">
                    <v-row justify="center" class="pr-2 pl-2">
                        <v-col v-for="(item , index) in playlist" :key="index" cols="12">
                            <v-row justify="start" class="pb-2">
                                <div class="views">
                                    <h2 class="mx-7" style="white-space: nowrap;">{{item.title}}</h2>
                                </div>
                ...
                <div class="pb-4" v-if="special.length !== 0">
                    <div class="views">
                        <h2 class="pr-3">پادکست های اختصاصی پادی</h2>
                    </div>

                    <v-row justify="center" class="pt-2 pr-10">
                        <v-col v-for="item in special" :key="item.id" cols="6" md="3">
                            <v-card height="125" min-width="125" shaped :disabled="item.disable"
                                    max-width="125" elevation="10">
                                <v-img class="cursor" :src="item.image" height="125" min-width="125"
                                       max-width="125" :aria-label="item.title" :title="item.title"
                                       @click="publisherPageNavigation(item.id)">
                                </v-img>
                            </v-card>
                        </v-col>
